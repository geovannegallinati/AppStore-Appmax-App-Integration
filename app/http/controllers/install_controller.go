...
func (c *InstallController) InstallStartFrontend(ctx http.Context, appID, externalKey string) http.Response {
	...
	page := frontendPageData{
		...
		Message:             "Click the button below to start the Appmax installation flow.",
		Submessage:          "A new tab will open and redirect you automatically to Appmax.",
		...
		DefaultExternalKey:  "",
		Tips: []string{
			"The install button sends a GET to /install/start with app_id and a generated external_key.",
