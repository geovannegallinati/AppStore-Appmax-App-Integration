...
func (c *InstallController) Start(ctx http.Context) http.Response {
	...
	if err != nil {
		...
		return ctx.Response().Json(502, responses.MessageResponse{Message: upstreamErrorMessage(err, "failed to initiate installation")})
	}
...
func (c *InstallController) CallbackGuide(ctx http.Context) http.Response {
	...
	if err != nil {
		...
		return ctx.Response().Json(502, responses.MessageResponse{Message: upstreamErrorMessage(err, "failed to generate merchant credentials")})
	}
